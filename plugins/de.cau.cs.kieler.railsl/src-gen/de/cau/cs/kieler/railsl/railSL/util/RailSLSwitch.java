...
public class RailSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        RailProgram railProgram = (RailProgram)theEObject;
        T result = caseRailProgram(railProgram);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Rail Program</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Rail Program</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRailProgram(RailProgram object)
  {
    return null;
  }
