...
@Singleton
public class RailSLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class BlockElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cEndBlockEndEnumRuleCall_3_0 = (RuleCall)cEndAssignment_3.eContents().get(0);
		...
		//BlockEnd
		public RuleCall getEndBlockEndEnumRuleCall_3_0() { return cEndBlockEndEnumRuleCall_3_0; }
	...
	public class TimeWaitStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cSecondsKeyword_3_0 = (Keyword)cAlternatives_3.eContents().get(0);
		private final Keyword cSecondKeyword_3_1 = (Keyword)cAlternatives_3.eContents().get(1);
		private final Keyword cFullStopKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//'second'
		public Keyword getSecondKeyword_3_1() { return cSecondKeyword_3_1; }
	...
	public class ConditionalStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cWaitKeyword_0_2_0_0 = (Keyword)cAlternatives_0_2_0.eContents().get(0);
		private final Keyword cWaitKeyword_0_2_0_1 = (Keyword)cAlternatives_0_2_0.eContents().get(1);
		private final Keyword cAnyKeyword_0_2_1 = (Keyword)cGroup_0_2.eContents().get(1);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		private final RuleCall cLinesConditionalLineParserRuleCall_3_0 = (RuleCall)cLinesAssignment_3.eContents().get(0);
		...
		//'wait'
		public Keyword getWaitKeyword_0_2_0_0() { return cWaitKeyword_0_2_0_0; }
		
		//'Wait'
		public Keyword getWaitKeyword_0_2_0_1() { return cWaitKeyword_0_2_0_1; }
		...
		//ConditionalLine
		public RuleCall getLinesConditionalLineParserRuleCall_3_0() { return cLinesConditionalLineParserRuleCall_3_0; }
	}
	public class ConditionalLineElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cFirstKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Keyword cCommaKeyword_8 = (Keyword)cGroup.eContents().get(8);
		private final Keyword cDoKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Assignment cBlockAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cBlockBlockParserRuleCall_10_0 = (RuleCall)cBlockAssignment_10.eContents().get(0);
		...
		//'first'
		public Keyword getFirstKeyword_7() { return cFirstKeyword_7; }
		...
		//block=Block
		public Assignment getBlockAssignment_10() { return cBlockAssignment_10; }
		
		//Block
		public RuleCall getBlockBlockParserRuleCall_10_0() { return cBlockBlockParserRuleCall_10_0; }
	}
	public class ParallelStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cJoinKeyword_4_0 = (Keyword)cAlternatives_4.eContents().get(0);
		private final Keyword cJoinKeyword_4_1 = (Keyword)cAlternatives_4.eContents().get(1);
		private final Keyword cFullStopKeyword_5 = (Keyword)cGroup.eContents().get(5);
		...
		//'Join'
		public Keyword getJoinKeyword_4_0() { return cJoinKeyword_4_0; }
		
		//'join'
		public Keyword getJoinKeyword_4_1() { return cJoinKeyword_4_1; }
		
		//'.'
		public Keyword getFullStopKeyword_5() { return cFullStopKeyword_5; }
	}
	
	public class BlockEndElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class TrackSpeedStopElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class TrackSpeedDriveElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class PointOrientationElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class ContactEventElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class ContactPositionElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class CrossingModeElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class LightModeElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	public class RailSegmentElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
