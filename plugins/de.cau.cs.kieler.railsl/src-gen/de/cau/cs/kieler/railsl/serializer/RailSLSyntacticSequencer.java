...
public class RailSLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ConditionalLine_CommaKeyword_8_q;
	...
	protected AbstractElementAlias match_ConditionalStatement_BranchKeyword_0_0_or_BranchKeyword_0_1_or_____WaitKeyword_0_2_0_0_or_WaitKeyword_0_2_0_1___AnyKeyword_0_2_1__;
	...
	protected AbstractElementAlias match_ParallelStatement_JoinKeyword_4_0_or_JoinKeyword_4_1;
	...
	protected AbstractElementAlias match_TimeWaitStatement_SecondKeyword_3_1_or_SecondsKeyword_3_0;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ConditionalLine_CommaKeyword_8_q = new TokenAlias(false, true, grammarAccess.getConditionalLineAccess().getCommaKeyword_8());
		...
		match_ConditionalStatement_BranchKeyword_0_0_or_BranchKeyword_0_1_or_____WaitKeyword_0_2_0_0_or_WaitKeyword_0_2_0_1___AnyKeyword_0_2_1__ = new AlternativeAlias(false, false, new GroupAlias(false, false, new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getConditionalStatementAccess().getWaitKeyword_0_2_0_0()), new TokenAlias(false, false, grammarAccess.getConditionalStatementAccess().getWaitKeyword_0_2_0_1())), new TokenAlias(false, false, grammarAccess.getConditionalStatementAccess().getAnyKeyword_0_2_1())), new TokenAlias(false, false, grammarAccess.getConditionalStatementAccess().getBranchKeyword_0_0()), new TokenAlias(false, false, grammarAccess.getConditionalStatementAccess().getBranchKeyword_0_1()));
		...
		match_ParallelStatement_JoinKeyword_4_0_or_JoinKeyword_4_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getParallelStatementAccess().getJoinKeyword_4_0()), new TokenAlias(false, false, grammarAccess.getParallelStatementAccess().getJoinKeyword_4_1()));
		...
		match_TimeWaitStatement_SecondKeyword_3_1_or_SecondsKeyword_3_0 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getTimeWaitStatementAccess().getSecondKeyword_3_1()), new TokenAlias(false, false, grammarAccess.getTimeWaitStatementAccess().getSecondsKeyword_3_0()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_ConditionalLine_CommaKeyword_8_q.equals(syntax))
				emit_ConditionalLine_CommaKeyword_8_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_ConditionalStatement_BranchKeyword_0_0_or_BranchKeyword_0_1_or_____WaitKeyword_0_2_0_0_or_WaitKeyword_0_2_0_1___AnyKeyword_0_2_1__.equals(syntax))
				emit_ConditionalStatement_BranchKeyword_0_0_or_BranchKeyword_0_1_or_____WaitKeyword_0_2_0_0_or_WaitKeyword_0_2_0_1___AnyKeyword_0_2_1__(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_ParallelStatement_JoinKeyword_4_0_or_JoinKeyword_4_1.equals(syntax))
				emit_ParallelStatement_JoinKeyword_4_0_or_JoinKeyword_4_1(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_TimeWaitStatement_SecondKeyword_3_1_or_SecondsKeyword_3_0.equals(syntax))
				emit_TimeWaitStatement_SecondKeyword_3_1_or_SecondsKeyword_3_0(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     segment=RailSegment 'is' 'reached' 'first' (ambiguity) 'do' block=Block
	 
	 * </pre>
	 */
	protected void emit_ConditionalLine_CommaKeyword_8_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 * </pre>
	 */
	protected void emit_ConditionalStatement_BranchKeyword_0_0_or_BranchKeyword_0_1_or_____WaitKeyword_0_2_0_0_or_WaitKeyword_0_2_0_1___AnyKeyword_0_2_1__(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 * </pre>
	 */
	protected void emit_ParallelStatement_JoinKeyword_4_0_or_JoinKeyword_4_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 * </pre>
	 */
	protected void emit_TimeWaitStatement_SecondKeyword_3_1_or_SecondsKeyword_3_0(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
