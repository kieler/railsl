...
public class RailSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RailSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTimeWaitStatementAccess().getAlternatives_3(), "rule__TimeWaitStatement__Alternatives_3");
			...
			builder.put(grammarAccess.getConditionalStatementAccess().getAlternatives_0_2_0(), "rule__ConditionalStatement__Alternatives_0_2_0");
			...
			builder.put(grammarAccess.getParallelStatementAccess().getAlternatives_4(), "rule__ParallelStatement__Alternatives_4");
			...
			builder.put(grammarAccess.getConditionalStatementAccess().getGroup_0_2(), "rule__ConditionalStatement__Group_0_2__0");
			...
			builder.put(grammarAccess.getBlockAccess().getEndAssignment_3(), "rule__Block__EndAssignment_3");
			...
			builder.put(grammarAccess.getConditionalStatementAccess().getLinesAssignment_3(), "rule__ConditionalStatement__LinesAssignment_3");
			...
			builder.put(grammarAccess.getConditionalLineAccess().getBlockAssignment_10(), "rule__ConditionalLine__BlockAssignment_10");
			builder.put(grammarAccess.getParallelStatementAccess().getBlocksAssignment_2(), "rule__ParallelStatement__BlocksAssignment_2");
			builder.put(grammarAccess.getParallelStatementAccess().getBlocksAssignment_3(), "rule__ParallelStatement__BlocksAssignment_3");
		}
	}
